...
int main(){
	...
	//Temporario(sera removido na proxima etapa)
	menuText();
		
	/* Prof pediu para o programa ser finalizado,
	 *  esse codigo não sera removido pois na proxima etapa ele já será implementado
	while(esc_menu != 0){
	menuText();
	}
	*/
