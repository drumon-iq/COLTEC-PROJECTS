...
int main()
{
    ...
    while(1){
        ...
        if((tentativas[vez].palavra[0] == 'q') && (strlen(tentativas[vez].palavra)-1 == 1)){
        ...
        if((tentativas[vez].palavra[0] == 'h') && (strlen(tentativas[vez].palavra)-1 == 1)){
        ...
        else
        {
            ...
            tentativas[vez].palavra[strlen(tentativas[vez].palavra)-1] ='\0';
